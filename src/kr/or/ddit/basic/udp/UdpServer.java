...
/*
	UDP방식 : 비연결 지향, 신뢰성 없다, 데이터가 순서대로 도착한다는 보장이 없다, 그렇지만 TCP방식보다 속도가 빠름
	...
	public static void main(String[] args) {
		try {
			...
			while(true) {
				...
				DatagramPacket outpaPacket = new DatagramPacket(sendMsg, sendMsg.length, address, port);
				
				// 데이터 송신하기 ==> send()메서드 이용
				socket.send(outpaPacket);
